...
#                                              coordinates=trajectory_coordinates)
    if not use_angle:
        ...
        print("Removed, frames", trajectories.values()[0].frames)
    ...
    if input_missing_steps:
        ...
        print("input_missing_steps, frames", trajectories.values()[0].frames)
    ...
    if not use_angle:
        ...
        print("change_coordinate_system, frames", trajectories.values()[0].frames)
